...
const PADDLE_SIZE: Vec3 = const_vec3!([120., 20., 0.]);
const GAP_BETWEEN_PADDLE_AND_FLOOR: f32 = 60.;
const PADDLE_SPEED: f32 = 500.;
//  How close the paddle can get to the wall
const PADDLE_PADDING: f32 = 10.;

//  We set the z-value of the ball to 1 so it renders on top in the case of overlapping sprites.
const BALL_STARTING_POSITION: Vec3 = const_vec3!([0., -50., 1.]);
...
const TEXT_COLOR: Color = Color::rgb(0.5, 0.5, 1.);
const SCORE_COLOR: Color = Color::rgb(1., 0.5, 0.5);
...
impl WallLocation {
    ...
    fn size(&self) -> Vec2 {
        ...
        match self {
            ...
            WallLocation::Bottom => Vec2::new(WALL_THICKNESS + arena_width, WALL_THICKNESS),
            WallLocation::Top => Vec2::new(WALL_THICKNESS + arena_width, WALL_THICKNESS),
        }
    }
}
...
impl WallBundle {
    ...
    fn new(location: WallLocation) -> WallBundle {
        WallBundle {
            sprite_bundle: SpriteBundle {
                transform: Transform {
                    //  We need to conver our Vec2 into a Vec3 by givit it a z-coordinate
...
//  Add the game's entities to our world in setup
